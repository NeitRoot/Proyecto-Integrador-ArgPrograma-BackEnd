...
import com.portfolio.Froggo.Dto.DtoExperiencia;
import com.portfolio.Froggo.Entity.Experiencia;
import com.portfolio.Froggo.Security.Controller.Mensaje;
import com.portfolio.Froggo.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody DtoExperiencia dtoexp) {
        ...
        if (!sExperiencia.existsById(id)) {
            return new ResponseEntity(new Mensaje("Esta experiencia no existe (ID inválido)"), HttpStatus.NOT_FOUND);
        }
